...
print('\n이순신~강감찬의 서울~목포 실적 include row data read of DataFrame')
result =myframe.loc['이순신':'강감찬', '서울':'목포']
print(type(result))
print(result)
print('-' * 50)

print('\n김유신~광해군의 부산 실적 include row data read of DataFrame')
...
result = myframe.loc[['이순신', '강감찬'], ['부산']] = 30
print(myframe)
print('-' * 50)

print('\ndata set 80 : 김유신 ~ 광해군 경주 실적')
result = myframe.loc['김유신':'광해군', ['경주']] = 80
print(myframe)
print('-' * 50)
